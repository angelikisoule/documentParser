...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12">
			...
			<a href="<c:url value="/persons/list"/>" class="btn btn-default btn-lg" role="button">List Of Persons</a> 
			<a href="<c:url value="/stats/list"/>" class="btn btn-default btn-lg" role="button">List Of Files</a> 
